...
import { RefreshCw, Clock, Database, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function RefreshPage() {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-3xl font-bold">Refresh Data</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Changes detected in last refresh
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardContent className="space-y-6 pt-6">
          <div>
            <h3 className="text-lg font-semibold mb-2">Manual Refresh</h3>
          ...
          <div>
            <Button
              variant="outline"
              className="w-full flex items-center justify-between p-4 border-2 hover:bg-accent hover:text-accent-foreground transition-colors"
              onClick={() => setShowHistory(!showHistory)}
            >
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-semibold">Refresh History</h3>
                <span className="text-sm text-muted-foreground">Click to {showHistory ? 'hide' : 'view'}</span>
              </div>
              {showHistory ? (
